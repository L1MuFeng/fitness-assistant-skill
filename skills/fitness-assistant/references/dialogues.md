# Dialogue scripts (fixed, 8 languages)

Every user-facing dialogue below has exactly one block per supported language. Send the block that matches the user's chosen language **verbatim** — do not translate, paraphrase, reorder, or add to it. These texts contain no placeholders; profile data is used only in the plan itself.
...
你好！我是你的健身助手，会为你定制一份专属的一日饮食计划和训练计划。为了让方案更适合你，我会先问你几个问题——你可以一次性全部回答，也可以一个一个来。
...
其中任何一项你拿不准，直接说“随便”就行，我会帮你选一个合理的默认方案。

### Español (es)

¡Hola! Soy tu asistente de fitness. Prepararé para ti un plan personalizado de comidas y entrenamiento para un día. Para que se ajuste bien a ti, primero te haré algunas preguntas: puedes responderlas todas de una vez o una por una.
...
Si algún punto no te importa, solo di «tú decides» y elegiré una opción razonable por defecto.

### हिन्दी (hi)

नमस्ते! मैं आपका फ़िटनेस सहायक हूँ। मैं आपके लिए एक दिन का व्यक्तिगत भोजन और कसरत का प्लान बनाऊँगा। इसे आपके लिए सही बनाने के लिए मैं पहले कुछ सवाल पूछूँगा — आप सबका जवाब एक साथ या एक-एक करके दे सकते हैं।
...
जिस किसी बात की आपको परवाह न हो, बस कहें “आप तय करें” और मैं उचित डिफ़ॉल्ट चुनूँगा।

### Français (fr)

Bonjour ! Je suis votre assistant fitness. Je vais vous préparer un plan personnalisé de repas et d'entraînement pour une journée. Pour qu'il vous convienne bien, je vais d'abord vous poser quelques questions — vous pouvez répondre d'un coup ou une par une.
...
Si un point ne vous importe pas, dites simplement « à vous de choisir » et je retiendrai une option raisonnable.

### العربية (ar)

مرحبًا! أنا مساعدك الرياضي. سأعد لك خطة يومية شخصية للوجبات والتمارين. ولتناسبك جيدًا، سأطرح عليك بعض الأسئلة أولًا — يمكنك الإجابة عنها كلها مرة واحدة أو واحدة تلو الأخرى.
...
أي أمر لا يهمك، قل فقط «أنت تقرر» وسأختار خيارًا مناسبًا افتراضيًا.

### Português (pt)

Olá! Sou o seu assistente de fitness. Vou preparar um plano personalizado de refeições e de treino para um dia. Para que ele se ajuste bem a você, farei algumas perguntas primeiro — você pode responder tudo de uma vez ou uma por uma.
...
Se algum item não for importante para você, é só dizer “você decide” e eu escolho uma opção sensata.

### Русский (ru)

Привет! Я ваш фитнес-ассистент. Составлю для вас персональный план питания и тренировок на один день. Чтобы он подошёл вам, сначала задам несколько вопросов — можно ответить сразу на все или по одному.
...
Если какой-то пункт вам не важен, просто скажите «решайте сами» — я выберу разумный вариант.
...
距离上次计划已经三天了。你想保持原计划，还是做一些调整？选项：全部保持 / 调整饮食菜单 / 调整训练计划 / 重新制定。另外，今天手头有哪些食材？我会根据它们为你推荐菜品。

### Español (es)

Ya han pasado tres días desde tu último plan. ¿Quieres mantenerlo o ajustarlo? Opciones: mantener todo / ajustar el menú / ajustar el plan de entrenamiento / rehacer desde cero. Además, ¿qué ingredientes tienes a mano hoy? Te recomendaré platos con ellos.

### हिन्दी (hi)

आपकी आख़िरी योजना को तीन दिन हो गए हैं। क्या आप इसे वैसे ही रखना चाहते हैं या बदलना चाहते हैं? विकल्प: दोनों वैसे ही रखें / मेनू बदलें / कसरत की योजना बदलें / नई योजना बनाएँ। साथ ही, आज घर में कौन-कौन सी सामग्री है? मैं उनसे व्यंजन सुझाऊँगा।

### Français (fr)

Trois jours se sont écoulés depuis votre dernier plan. Voulez-vous le garder ou l'ajuster ? Options : tout garder / ajuster le menu / ajuster le plan d'entraînement / tout refaire. Aussi, quels ingrédients avez-vous sous la main aujourd'hui ? Je recommanderai des plats à partir de ceux-ci.

### العربية (ar)

مرّت ثلاثة أيام على خطتك الأخيرة. هل تريد الإبقاء عليها أم تعديلها؟ الخيارات: الإبقاء على كل شيء / تعديل قائمة الطعام / تعديل خطة التمرين / إعادة البناء من الصفر. وأيضًا: ما المكونات المتوفرة لديك اليوم؟ سأقترح أطباقًا بناءً عليها.

### Português (pt)

Já se passaram três dias desde o seu último plano. Quer mantê-lo ou ajustá-lo? Opções: manter tudo / ajustar o cardápio / ajustar o plano de treino / refazer do zero. E aí, quais ingredientes você tem à mão hoje? Vou recomendar pratos usando eles.

### Русский (ru)

Прошло три дня с вашего последнего плана. Хотите оставить его или скорректировать? Варианты: оставить всё / изменить меню / изменить план тренировок / составить заново. И ещё: какие продукты есть у вас сегодня? Я предложу блюда на их основе.

## 3. Training-log follow-up

### English (en)

Did you finish today's workout? Please tell me: actual training time, intensity (light / moderate / high or RPE), duration, and how it felt (too easy / on target / very hard). I'll use it to prepare your next session.

### 简体中文 (zh-CN)

今天的训练完成了吗？请告诉我：实际训练时间、强度（轻 / 中 / 高或 RPE）、时长，以及体感（太轻松 / 正好 / 非常吃力）。我会据此准备你的下一次训练。

### Español (es)

¿Terminaste el entrenamiento de hoy? Cuéntame: hora real del entrenamiento, intensidad (baja / media / alta o RPE), duración y cómo te sentiste (muy fácil / adecuado / muy duro). Lo usaré para preparar tu próxima sesión.

### हिन्दी (hi)

क्या आपने आज की कसरत पूरी की? कृपया बताएँ: वास्तविक कसरत का समय, तीव्रता (हल्की / मध्यम / तेज़ या RPE), अवधि, और कैसा महसूस हुआ (बहुत आसान / सही / बहुत कठिन)। मैं इसका उपयोग आपके अगले सत्र की तैयारी में करूँगा।

### Français (fr)

Avez-vous terminé votre séance d'aujourd'hui ? Dites-moi : heure réelle de l'entraînement, intensité (légère / modérée / élevée ou RPE), durée et ressenti (trop facile / conforme / très dur). Je m'en servirai pour préparer votre prochaine séance.

### العربية (ar)

هل أنهيت تمرين اليوم؟ أخبرني من فضلك: الوقت الفعلي للتدريب، والشدة (خفيفة / متوسطة / عالية أو RPE)، والمدة، وكيف شعرت (سهل جدًا / مناسب / صعب جدًا). سأستخدم ذلك في التحضير لجلسة التدريب القادمة.

### Português (pt)

Você terminou o treino de hoje? Me conta: horário real do treino, intensidade (leve / moderada / alta ou RPE), duração e como você se sentiu (muito fácil / na medida / muito difícil). Vou usar isso para preparar a sua próxima sessão.
